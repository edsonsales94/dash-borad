                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 100%;">
                    <tr>
                        ...
                        <td align="right" valign="top" style="padding: 25px 20px;">
                            <img width="160" src="img/logogamapreto.png" alt="logoCult">
                        </td>
    ...
    <tr>
        <td align="center" bgcolor="#C1ECE0">
            <table align="center " border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:90%;">
                ...
                <!-- start copy -->
                <tr>
                    <td align="center" bgcolor="#C1ECE0" width="100" height='100' style="padding: 10px 24px 0px 24px; font-family:  Source Sans Pro , Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                        <table  align="center " border="0" cellpadding="0" cellspacing="0" width="100%"">
                            <thead align="center ">
								...
								<tr align="center " >
                                    <td class="cabe-dia "></td>
                                    <td class="cabec-nome "></td>
                                    <td class="cabec-area "></td>
                                </tr>
								<tr align="center " >
                                    <td class="cabe-dia "></td>
                                    <td class="cabec-nome "></td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 100%; margin-bottom:20px;">																																							 
                    <td style="width: 100%;padding:20px 0 0 0; ">
                        <p align='center' style="font-size: 40px; ">Desejamos a todos muita saúde e felicidade.</p>
                        <!--<p style="font-size: 40px; padding-left: 10px; margin-top: 0;margin-bottom:0;margin-left: 10px;"></p>-->
                    </td>
                    <!--<td style="width: 20%; text-align: center; padding-right:45px;">
                        <img width="150" src="img/logopessoa.png" alt="logoCult">
